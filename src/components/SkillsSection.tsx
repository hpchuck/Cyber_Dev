  ...
  return (
    <section id="skills" className="py-12 px-4 md:px-8 relative overflow-hidden">
      ...
      >
        ...
        <div 
          ref={scrollRef}
          className="flex gap-6 overflow-x-hidden py-4 no-scrollbar"
          ...
          <div className="flex gap-6 min-w-max">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className={`relative group p-6 rounded-lg backdrop-blur-md bg-black/40 border border-[#00FF41]/10 hover:border-[#00FF41]/30 transition-all duration-300 overflow-hidden flex flex-col items-center justify-center gap-4 w-48 ${
